...
|Api Root|https://{dev-instance}.service-now.com/api/now/v1/|True|https://googlellcdemo4.service-now.com/api/now/v1/|
...
|Client ID|Client ID of Service Now application. Required for Oauth authentication.|False|52cddf591e524b719f42a36fab9e0ea6|
...
|Days Backwards|Fetch incidents from 'x' days backwards. e.g. 3|False|500|
